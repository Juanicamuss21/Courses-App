...
const Landing = () => {
  ...
  <div className='div-landing'>
    <div className='presentation'>
      ...
      <p> Bienvenido a nuestra plataforma de cursos de programación. Aquí encontrarás una amplia variedad de cursos de programación de alta calidad, tanto de frontend como de backend, para que puedas aprender y mejorar tus habilidades en el mundo de la programación.
      </p>
      <p>
